...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="/">STE<span class="navbar-half">LLA</span></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="{{route('menus.index')}}" class="nav-link">Menu</a></li>
                    <li class="nav-item"><a href="{{route('reservations.step.one')}}" class="nav-link">Make
                            Reservation</a></li>
                ...
                <div class="col-md-12 text-center">
                    ...
                    <p class="mb-0">
                        ...
                        document.write(new Date().getFullYear());
                            ...
                            aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Priyanshi</a>
                    </p>
                </div>
            </div>
        </div>
